...
public class Gradebook {
    ...
    private float averageOverallGrade;
    ...
    public float getAverageOverallGrade() {
        return averageOverallGrade;
    }

    public void setAverageOverallGrade(float averageOverallGrade) {
        this.averageOverallGrade = averageOverallGrade;
    }
